...
import { Shield, FileText, ChevronRight, Stethoscope, Building2, FlaskConical, BarChart3, ReceiptText } from "lucide-react";
      ...
      <Card>
        ...
        <CardContent className="p-0">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="text-sm font-medium">И-Баримт (PosAPI)</div>
              <div className="text-xs text-muted-foreground mt-0.5">
                Татварын И-Баримт холболтын тохиргоо — merchantTin, кассын дугаар
              </div>
            </div>
            <ChevronRight className="h-4 w-4 text-muted-foreground shrink-0" />
          </Link>
